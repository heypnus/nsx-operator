...
//
// On any API error while fetching the namespace, the event is allowed through
// so the Reconcile function can decide what to do.
func VPCNamespacePredicate(c client.Reader) predicate.Funcs {
	...
	return predicate.Funcs{
		...
		// resources regardless of the current namespace label.
